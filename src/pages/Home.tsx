...
const Home = () => {
  return (
    <div className="min-h-screen bg-gradient-to-b from-playscribe-lightGray to-white">
      <div className="container mx-auto px-4 py-12 flex flex-col items-center">
        ...
        <h1 className="text-4xl md:text-5xl font-bold text-center mb-4">
          ...
          <br />
          <span className="text-playscribe-teal">Through Stories & Games</span>
        </h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10 w-full max-w-4xl">
          <div className="card-container flex flex-col items-center text-center p-8">
            <div className="bg-playscribe-coral w-24 h-24 rounded-full flex items-center justify-center mb-4">
        ...
        <div className="mt-16 max-w-2xl text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="flex flex-col items-center">
              <div className="w-12 h-12 rounded-full bg-playscribe-teal text-white flex items-center justify-center text-lg font-bold mb-3">
                2
              </div>
              <p className="text-sm">PlayScribe transforms stories into interactive games</p>
            </div>
            <div className="flex flex-col items-center">
              <div className="w-12 h-12 rounded-full bg-playscribe-coral text-white flex items-center justify-center text-lg font-bold mb-3">
                3
              </div>
