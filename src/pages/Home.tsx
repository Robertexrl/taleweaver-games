    ...
    <div className="min-h-screen bg-gradient-to-b from-taleweaver-lightPurple/50 to-white">
      <div className="container mx-auto px-4 py-12 flex flex-col items-center">
        ...
        <h1 className="text-4xl md:text-5xl font-bold text-center mb-4">
          <span className="text-taleweaver-darkPurple">Connecting Generations</span>
          <br />
          <span className="text-taleweaver-purple">Through Stories & Games</span>
        </h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10 w-full max-w-4xl">
          <div className="card-container flex flex-col items-center text-center p-8">
            <div className="bg-taleweaver-peach w-24 h-24 rounded-full flex items-center justify-center mb-4">
              <svg className="w-12 h-12" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M12 16C15.866 16 19 12.866 19 9C19 5.13401 15.866 2 12 2C8.13401 2 5 5.13401 5 9C5 12.866 8.13401 16 12 16Z" stroke="#7E69AB" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
                <path d="M12 16V22" stroke="#7E69AB" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
                <path d="M8 18H16" stroke="#7E69AB" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
              </svg>
            </div>
            <h2 className="text-2xl font-bold mb-3">Storytellers</h2>
          ...
          <div className="card-container flex flex-col items-center text-center p-8">
            <div className="bg-taleweaver-blue w-24 h-24 rounded-full flex items-center justify-center mb-4">
              <svg className="w-12 h-12" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                <rect x="3" y="4" width="18" height="12" rx="2" stroke="#7E69AB" strokeWidth="2"/>
                <path d="M10 8L16 12L10 16V8Z" fill="#7E69AB"/>
                <path d="M7 20H17" stroke="#7E69AB" strokeWidth="2" strokeLinecap="round"/>
              </svg>
            </div>
            <h2 className="text-2xl font-bold mb-3">Game Players</h2>
            <p className="mb-6 text-gray-600">
