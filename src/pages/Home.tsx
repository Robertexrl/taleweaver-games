    ...
    <div className="min-h-screen bg-background">
      <div className="container mx-auto px-4 py-12 flex flex-col items-center">
        ...
        <h1 className="text-4xl md:text-5xl font-bold text-center mb-4">
          ...
          <br />
          <span className="text-playscribe-purple-light">Through Stories & Games</span>
        </h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10 w-full max-w-4xl">
          <div className="card-container flex flex-col items-center text-center p-8">
            ...
            <h2 className="text-2xl font-bold mb-3 text-playscribe-coral">Storytellers</h2>
          ...
          <div className="card-container flex flex-col items-center text-center p-8">
            ...
            <h2 className="text-2xl font-bold mb-3 text-playscribe-coral">Game Players</h2>
            <p className="mb-6 text-gray-600">
        ...
        <div className="mt-16 max-w-2xl text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="flex flex-col items-center">
              <div className="w-12 h-12 rounded-full bg-playscribe-purple-light text-white flex items-center justify-center text-lg font-bold mb-3">
                1
              </div>
